...
class TemperatureTracker(object):
    ...
    def insert(self, temperatures: list, *args: list):
        ...
        if not isinstance(temperatures, list):
            ...
            return self.templist[0] + self.templist[1:]
        # Handle case where optional parm IS provided

...
class Window(QWidget, Ui_Window):
    ...
    def loadFiles(self):
        ...
        if len(files) > 0:
            ...
            self.filesCount = len(self.files)
            self.updateStateFilesLoaded()

    def updateStateNoFiles(self):
        self.filesCount = len(self.files)
    ...
    def updateStateWhileRename(self):
        self.loadFilesButton.setEnabled(False)
        self.renameFilesButton.setEnabled(False)

    def updateStateFilesLoaded(self):
    ...
    def runRenamerThread(self):
        ...
        self.renamer.finished.connect(self.updateStateNoFiles)
        # Clean up
